...
let serverPool = ['sjc.o00o.ooo'];
let yourUUID = '01010101-0101-4101-8101-010101010101';

let cfip = [ // cfip
	'ip.sb', 'time.is', 'www.visa.cn', 'ww.visa.com.tw', 'www.visa.com.hk', 'www.visa.com.sg',
...
function getVLConfig(yourUUID, url) {
	...
	const header =  atob(atob('ZG14bGMzTT0='));
	...
	return configs.join('\n').replace(new RegExp(header, 'g'), '${header}');
}
...
<body>
    <div class="login-container">
        ...
        <div class="footer">
            <p>Powered by eooce <a href="https://t.me/" target="_blank" style="color: #007bff; text-decoration: none;">Telegram</a></p>
        </div>
    </div>
